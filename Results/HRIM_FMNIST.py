...
data_train = datasets.FashionMNIST('/Users/kosio/Data/FashionMNIST/', train=True, transform=transform, download=True)
data_test = datasets.FashionMNIST('/Users/kosio/Data/FashionMNIST/', train=False, transform=transform, download=True)
...
#%% Degree of error measured in terms of the distance between the FMNIST predicted labels
